...
public class SteeringWheel : MonoBehaviour
{
    ...
    float vertical = 0f;
    bool acceleratorBeingHeld = false;
    [SerializeField] float acceleratorSpeed = 10f;
    ...
    void Update()
    {
        ...
        if( acceleratorBeingHeld && vertical<1)
        {
            vertical += Time.deltaTime * acceleratorSpeed;  
        }
        else if(!wheelBeingHeld && !acceleratorBeingHeld && vertical>0)
        {
            vertical -= Time.deltaTime * acceleratorSpeed;
        }
    ...
    public void PressEvent2(BaseEventData eventData)
    {
        acceleratorBeingHeld = true;
    }
    public void ReleaseEvent2(BaseEventData eventData)
    {
        acceleratorBeingHeld = false;
    }

    public float GetVertical()
    {
        return vertical * verticalFactor;
    }
